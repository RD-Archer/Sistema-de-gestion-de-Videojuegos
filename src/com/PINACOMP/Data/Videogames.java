...
public class Videogames {
    private List<Videojuegos> tienda;
    public Videogames(){
    ...
    private void crearVideojuegos(){
        ...
        tienda.add( new Videojuegos("Burnout", 500, s1, TipoClasificacion.B, TipoGenero.DEPORTES, f1, "EA", 2));
        Sistema s2 = new Sistema(TipoConsola.PLAYSTATION,"Ken kutaragi","4",f2);
        tienda.add(new Videojuegos("Spiderman", 1500, s2, TipoClasificacion.A, TipoGenero.AVENTURA, f2, "Insomiac Games", 1));
        Sistema s3 = new Sistema(TipoConsola.NINTENDO,"Shigeru Miyamoto","switch",f3);
        tienda.add(new Videojuegos("Super Smash Bros. Ultimate", 899, s3, TipoClasificacion.A, TipoGenero.ACCION, f3, "Bandai Namco", 4));
    ...
    public List<Videojuegos> getTienda(){
        return tienda;
    }
}
